                    ...
                    for (TLRPC.Message message: res.messages) {
                        ...
                        if(message.media!=null){
                            ...
                            if(message.media.audio_unused !=null){
                                ...
                                asyncDownloadFile(operation,getAppDir(context),getAppCacheDir(context));
                            ...
                            if(localFile==null && (message.message==null||message.message.isEmpty())){
                                ...
                                try {
                                    outputStream = new DataOutputStream(new FileOutputStream(localFile));
                                    outputStream.writeUTF("Cant read msg id "+message.id+" media_type "+message.media.getClass());
                                } catch (Exception e) {
                                    e.printStackTrace();
                                }
                                filePath="Cannot parse media type "+message.media.getClass().getName();
